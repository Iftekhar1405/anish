...
export default function FarmerHome() {
  ...
  return (
    <View className="flex-1 items-center justify-center bg-neutral-50 px-6">
      <Text className="text-3xl font-bold text-primary-700">AI Platform — Farmer</Text>
      <Text className="mt-2 text-center text-base text-neutral-500">
        Signed in as {user?.phone}. Animals, catalogue browsing, and booking land in later
        phases.
      </Text>
      <Pressable
        onPress={() => void logout()}
