    ...
    <View className="flex-1 gap-3 bg-neutral-50 p-4">
      {query.isLoading ? (
        ...
        <EmptyState
          ...
          description="Bookings the admin assigns to you will show up here."
        />
      ) : (
        <FlatList
          data={items}
          ...
          renderItem={({ item }) => <AssignmentCard booking={item} />}
        />
      )}
    </View>
  );
...
function AssignmentCard({ booking }: { booking: Booking }) {
