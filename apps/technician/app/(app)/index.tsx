...
export default function TechnicianHome() {
  ...
  return (
    <View className="flex-1 items-center justify-center bg-neutral-50 px-6">
      <Text className="text-3xl font-bold text-primary-700">AI Platform — Technician</Text>
      <Text className="mt-2 text-center text-base text-neutral-500">
        Signed in as {user?.phone}. Today's schedule, navigation, and service recording land in
        later phases.
      </Text>
      <Pressable
        onPress={() => void logout()}
